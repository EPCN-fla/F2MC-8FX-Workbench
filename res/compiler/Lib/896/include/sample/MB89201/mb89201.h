...
typedef const unsigned short __DWORD;
...
#define	SYCC_SCM  	(IO_SYCC.bit.SCM)
...
#define	UPC_RP  	(IO_UPC.bit.RP)
#define	UPC_RP0  	(IO_UPC.bitc.RP0)
#define	UPC_RP1  	(IO_UPC.bitc.RP1)
#define	UPC_RP2  	(IO_UPC.bitc.RP2)
...
__IO_EXTERN	 const  ADDSTR	IO_ADD;
#define	_add		(IO_ADD)
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_PDR6, locate=0x60
#endif
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_PUL6, locate=0x62
#endif
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_PDR7, locate=0x63
#endif
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_DDR7, locate=0x64
#endif
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_PUL7, locate=0x65
#endif
...
#define	PUL7_PUL70  	(IO_PUL7.bit.PUL70)
#define	PUL7_PUL71  	(IO_PUL7.bit.PUL71)
#define	PUL7_PUL72  	(IO_PUL7.bit.PUL72)
...
#ifdef __IO_DEFINE
#pragma segment IO=IO_FMCS, locate=0x79
#endif
...
__IO_EXTERN	  FMCSSTR	IO_FMCS;
#define	_fmcs		(IO_FMCS)
#define	FMCS		(IO_FMCS.byte)
#define	FMCS_RDY  	(IO_FMCS.bit.RDY)
#define	FMCS_WE  	(IO_FMCS.bit.WE)
#define	FMCS_RDYINT  	(IO_FMCS.bit.RDYINT)
#define	FMCS_INTE  	(IO_FMCS.bit.INTE)
