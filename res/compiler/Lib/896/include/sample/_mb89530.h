/*
 MB89530 Series I/O register declaration file V30L08
...
__IO_EXTERN __UNION_D(io_pdr3,IO_DDR3)		/* addr 0Fh */
...
__IO_STATIC __RESERVE_D(dmy_14_21,14)		/* addr 14-21h */
...
__IO_EXTERN __UNION_D(io_ppgc,IO_PPGC2)		/* addr 38h */
__IO_EXTERN __UNION_D(io_prl2,IO_PRL22)		/* addr 39h */
__IO_EXTERN __UNION_D(io_prl1,IO_PRL21)		/* addr 3Ah */
__IO_EXTERN __UNION_D(io_prl3,IO_PRL23)		/* addr 3Bh */
...
__IO_STATIC __RESERVE_D(dmy_41_48,8)		/* addr 41-48h */
__IO_EXTERN __UNION_D(io_ddcr,IO_DDCR)		/* addr 49h */
__IO_STATIC __RESERVE_D(dmy_4A_4B,2)		/* addr 4A-4Bh */
__IO_EXTERN __UNION_D(io_ppgc,IO_PPGC1)		/* addr 4Ch */
__IO_EXTERN __UNION_D(io_prl2,IO_PRL12)		/* addr 4Dh */
__IO_EXTERN __UNION_D(io_prl1,IO_PRL11)		/* addr 4Eh */
__IO_EXTERN __UNION_D(io_prl3,IO_PRL13)		/* addr 4Fh */
__IO_EXTERN __UNION_D(io_iacr,IO_IACR)		/* addr 50h */
...
__IO_STATIC __RESERVE_D(dmy_5B_6F,21)		/* addr 5B-6Fh */
...
__IO_EXTERN __UNION_D(io_purr3,IO_PURR3)	/* addr 75h */
__IO_EXTERN __UNION_D(io_purr4,IO_PURR4)	/* addr 76h */
__IO_EXTERN __UNION_D(io_wren,IO_WREN)		/* addr 77h */
__IO_EXTERN __UNION_D(io_wror,IO_WROR)		/* addr 78h */
__IO_EXTERN __UNION_D(io_purr6,IO_PURR6)	/* addr 79h */
