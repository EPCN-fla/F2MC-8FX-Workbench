/*
 MB89890 Series I/O register declaration file V30L08
...
__IO_EXTERN __UNION_D(io_pdr9,IO_DDR9)		/* addr 19h */
__IO_EXTERN __UNION_D(io_pdra,IO_PDRA)		/* addr 1Ah */
__IO_EXTERN __UNION_D(io_pdra,IO_DDRA)		/* addr 1Bh */
...
__IO_EXTERN __UNION_D(io_sbmr,IO_SBMR)		/* addr 22h */
__IO_EXTERN __UNION_D(io_sbfr,IO_SBFR)		/* addr 23h */
__IO_EXTERN __UCHAR_D(IO_SBUF)			/* addr 24h */
__IO_EXTERN __CONST __UCHAR_D(IO_SBDR)		/* addr 25h */
...
__IO_EXTERN __CONST __UNION_D(io_mld,IO_MLD)	/* addr 36-37h */
__IO_STATIC __RESERVE_D(dmy_38_3C,5)		/* addr 38-3Ch */
