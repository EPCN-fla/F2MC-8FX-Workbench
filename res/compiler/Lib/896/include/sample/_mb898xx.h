...
#if defined(__CPU_MB89830_SERIES)
__STRUCT  io_add_bit0 __STRUCT_B
	__USHORTBIT(	DATA10,10)
	__USHORTBIT_NONAME(     6)
__STRUCT_E

__STRUCT  io_add_bit1 __STRUCT_B
	__USHORTBIT_NONAME(     6)
	__USHORTBIT(	DATA10,10)
__STRUCT_E
