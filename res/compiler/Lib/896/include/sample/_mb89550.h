/*
 MB89550A Series I/O register declaration file V30L08
...
__IO_STATIC __RESERVE_D(dmy_04_06,3)		/* addr 04h */
...
__IO_EXTERN __UNION_D(io_pdr7,IO_PDR7)		/* addr 15h */
__IO_STATIC __RESERVE_D(dmy_16,1)		/* addr 16h */
__IO_EXTERN __UNION_D(io_pdr8,IO_PDR8)		/* addr 17h */
__IO_EXTERN __UNION_D(io_pdr8,IO_DDR8)		/* addr 18h */
__IO_STATIC __RESERVE_D(dmy_19,1)		/* addr 19h */
__IO_EXTERN __UNION_D(io_t2cr,IO_T2CR2)		/* addr 1Ah */
__IO_EXTERN __UNION_D(io_t1cr,IO_T1CR1)		/* addr 1Bh */
__IO_EXTERN __UNION_D(io_t12dr,IO_T12DR12)	/* addr 1C-1Dh */
__IO_EXTERN __UNION_D(io_t2cr,IO_T2CR4)		/* addr 1Eh */
__IO_EXTERN __UNION_D(io_t1cr,IO_T1CR3)		/* addr 1Fh */
__IO_EXTERN __UNION_D(io_t12dr,IO_T12DR34)	/* addr 20-21h */
...
__IO_STATIC __RESERVE_D(dmy_38_3B,4)		/* addr 38-3Bh */
__IO_EXTERN __UNION_D(io_tmcr,IO_TMCR)		/* addr 3Ch */
__IO_EXTERN __USHORT_D(IO_TCR)			/* addr 3D-3Eh */
...
__IO_EXTERN __UNION_D(io_dacr,IO_DACR)		/* addr 43h */
__IO_EXTERN __UCHAR_D(IO_DADR1)			/* addr 44h */
__IO_EXTERN __UCHAR_D(IO_DADR2)			/* addr 45h */
__IO_STATIC __RESERVE_D(dmy_46_55,16)		/* addr46-55h */
...
__IO_EXTERN __UCHAR_D(IO_LCD2)			/* addr 5Fh */
...
__IO_EXTERN __UNION_D(io_purr8,IO_PURR8)	/* addr 76h */
__IO_EXTERN __UNION_D(io_wren,IO_WREN)		/* addr 77h */
__IO_STATIC __RESERVE_D(dmy_78,1)		/* addr 78h */
