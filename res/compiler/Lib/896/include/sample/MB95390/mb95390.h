...
#ifdef __IO_DEFINE
#pragma segment     DATA=IO_CPCHR,   locate=0xFDE
#endif

__IO_EXTENDED	__BYTE	IO_CPCHR;
#define	_cpchr		(IO_CPCHR)
#define	CPCHR	(_cpchr)
...
#define	ILSR_P60_P73  	(IO_ILSR.bit.P60_P73)
#define	ILSR_P61_P72  	(IO_ILSR.bit.P61_P72)
#define	ILSR_P77  	(IO_ILSR.bit.P77)
#define	ILSR_P47  	(IO_ILSR.bit.P47)
