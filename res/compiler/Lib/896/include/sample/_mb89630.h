/*
 MB89630/630R Series I/O register declaration file V30L08
...
__IO_EXTERN __UNION_D(io_chg3,IO_CHG3)		/* addr 0Ch */
__IO_EXTERN __UNION_D(io_pdr3,IO_PDR3)		/* addr 0Dh */
__IO_EXTERN __UCHAR_D(IO_DDR3)			/* addr 0Eh */
__IO_EXTERN __UNION_D(io_pdr4,IO_PDR4)		/* addr 0Fh */
__IO_EXTERN __UCHAR_D(IO_DDR4)			/* addr 10h */
__IO_EXTERN __UNION_D(io_bzcr,IO_BZCR)		/* addr 11h */
__IO_EXTERN __UNION_D(io_pdr5,IO_PDR5)		/* addr 12h */
__IO_EXTERN __UNION_D(io_pdr6,IO_PDR6)		/* addr 13h */
__IO_EXTERN __CONST __UNION_D(io_pdr7,IO_PDR7)	/* addr 14h */
__IO_EXTERN __UNION_D(io_pcr1,IO_PCR1)		/* addr 15h */
__IO_EXTERN __UNION_D(io_pcr2,IO_PCR2)		/* addr 16h */
__IO_EXTERN __UCHAR_D(IO_RLBR)			/* addr 17h */
...
__IO_EXTERN __UNION_D(io_smc,IO_SMC)		/* addr 2Dh */
__IO_EXTERN __UNION_D(io_src,IO_SRC)		/* addr 2Eh */
__IO_EXTERN __UNION_D(io_ssd,IO_SSD)		/* addr 2Fh */
__IO_EXTERN __UCHAR_D(IO_SIDR)			/* addr 30h */
__IO_STATIC __RESERVE_D(dmy_31_7B,75)		/* addr 31-7Bh */
