/*
 MB89590 Series I/O register declaration file V30L08
...
__IO_STATIC __RESERVE_D(dmy_14_20,13)		/* addr 14-20h */
...
__IO_EXTERN __UNION_D(io_hdsr,IO_HDSR1)		/* addr 41h */
...
__IO_EXTERN __UNION_D(io_sdsr,IO_SDSR)		/* addr 47h */
