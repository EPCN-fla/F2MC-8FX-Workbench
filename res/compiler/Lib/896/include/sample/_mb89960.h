/*
 MB89960 Series I/O register declaration file V30L08
...
__IO_EXTERN __CONST __UNION_D(io_ibsr,IO_IBSR)	/* addr 10h */
__IO_EXTERN __UNION_D(io_ibcr,IO_IBCR)		/* addr 11h */
__IO_EXTERN __UNION_D(io_iccr,IO_ICCR)		/* addr 12h */
__IO_EXTERN __UNION_D(io_iadr,IO_IADR)		/* addr 13h */
__IO_EXTERN __UCHAR_D(IO_IDAR)			/* addr 14h */
__IO_STATIC __RESERVE_D(dmy_15_17,3)		/* addr 15-17h */
...
__IO_EXTERN __CONST __UNION_D(io_add,IO_ADD)	/* addr 22-23h */
...
__IO_EXTERN __UNION_D(io_purr1,IO_PURR1)	/* addr 28h */
__IO_EXTERN __UNION_D(io_purr2,IO_PURR2)	/* addr 29h */
__IO_EXTERN __UNION_D(io_purr3,IO_PURR3)	/* addr 2Ah */
__IO_EXTERN __UNION_D(io_purr4,IO_PURR4)	/* addr 2Bh */
__IO_STATIC __RESERVE_D(dmy_2C_31,6)		/* addr 2C-31h */
