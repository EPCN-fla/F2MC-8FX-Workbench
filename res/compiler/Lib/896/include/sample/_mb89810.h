/*
 MB89810A Series I/O register declaration file V30L08
...
__IO_STATIC __RESERVE_D(dmy_12_16,5)		/* addr 12-16h */
__IO_EXTERN __UNION_D(io_pive,IO_PIVE)		/* addr 17h */
...
__IO_STATIC __RESERVE_D(dmy_2D_2E,2)		/* addr 2D-2Eh */
__IO_EXTERN __UNION_D(io_pwcr,IO_PWCR)		/* addr 2Fh */
__IO_EXTERN __UNION_D(io_eic1,IO_EIC1)		/* addr 30h */
__IO_EXTERN __UNION_D(io_eic2,IO_EIC2)		/* addr 31h */
__IO_EXTERN __UNION_D(io_ei2e,IO_EI2E)		/* addr 32h */
__IO_EXTERN __UNION_D(io_ei2f,IO_EI2F)		/* addr 33h */
