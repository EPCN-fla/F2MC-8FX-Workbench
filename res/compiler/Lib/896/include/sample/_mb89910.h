/*
 MB89910 Series I/O register declaration file V30L08
...
__IO_EXTERN __UNION_D(io_pdr1,IO_PDR1)		/* addr 10h */
__IO_EXTERN __UNION_D(io_pdr2,IO_PDR2)		/* addr 11h */
__IO_EXTERN __UNION_D(io_pdr5,IO_PDR5)		/* addr 12h */
__IO_EXTERN __CONST __UNION_D(io_pdr6,IO_PDR6)	/* addr 13h */
__IO_EXTERN __UNION_D(io_pdr4,IO_PDR4)		/* addr 14h */
__IO_EXTERN __UCHAR_D(IO_DDR4)			/* addr 15h */
__IO_EXTERN __UCHAR_D(IO_COMR)			/* addr 16h */
__IO_EXTERN __UNION_D(io_cntr,IO_CNTR)		/* addr 17h */
...
__IO_EXTERN __UCHAR_D(IO_ADCD)			/* addr 20h */
__IO_STATIC __RESERVE_D(dmy_21,1)		/* addr 21h */
__IO_EXTERN __UCHAR_D(IO_PCR)			/* addr 22h */
__IO_EXTERN __UNION_D(io_lvrc,IO_LVRC)		/* addr 23h */
