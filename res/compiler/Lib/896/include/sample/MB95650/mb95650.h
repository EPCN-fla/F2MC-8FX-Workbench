...
#ifdef __IO_DEFINE
#pragma segment IO=IO_ADC3, locate=0x70
#endif
...
#define	SYSC2_I2C_SEL  	(IO_SYSC2.bit.I2C_SEL)
#define	SYSC2_TO10SL  	(IO_SYSC2.bit.TO10SL)
#define	SYSC2_EC0SL  	(IO_SYSC2.bit.EC0SL)
