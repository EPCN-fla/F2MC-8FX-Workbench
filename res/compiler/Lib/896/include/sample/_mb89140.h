/*
 MB89140 Series I/O register declaration file V30L08
...
__IO_EXTERN __UNION_D(io_mcnt,IO_MCNT)		/* addr 24h */
__IO_EXTERN __UNION_D(io_intstr,IO_INTSTR)	/* addr 25h */
__IO_EXTERN __USHORT_D(IO_CMCLBR)		/* addr 26-27h */
__IO_EXTERN __USHORT_D(IO_OUTCBR)		/* addr 28-29h */
__IO_STATIC __RESERVE_D(dmy_2A_7B,82)		/* addr 2A-7Bh */
